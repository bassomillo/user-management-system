...
<script>
    ...
    document.getElementById("password").addEventListener("blur",function (){
        Ajax("POST","user/checkUserPassword","password="+passwordInput.value,function (data2){
            if(data2==="nullPassword"){
                document.getElementById("msg").setAttribute("style","color: red")
                document.getElementById("msg1").innerText = "password cannot be null"
            }
            if(data2==="legal password"){
                document.getElementById("msg1").setAttribute("style","color: blue")
                document.getElementById("msg1").innerText = "password can be used"
            }
        });
    })
